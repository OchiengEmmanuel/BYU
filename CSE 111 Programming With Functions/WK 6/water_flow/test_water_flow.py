...
def test_water_column_height():
    """This test function must call water_column_height at least 
    four times to verify that it is working correctly"""
...
def test_pressure_loss_from_pipe():
    """This test function must call pressure_loss_from_pipe at
    least seven times to verify that it is working correctly"""
...
def test_pressure_loss_from_fittings():
    """This test function must call pressure_loss_from_fittings
...
def test_reynolds_number():
    """This test function must call reynolds_number
    at least five times to verify that it is working correctly"""
...
def test_pressure_loss_from_pipe_reduction():
    """
    This test function calls pressure_loss_from_pipe_reduction
    at least three times to verify that it is working correctly.
    """
