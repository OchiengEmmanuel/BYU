...
def make_sentence(quantity, tense):
    ...
    #Exceeding the Requirements so that each sentence includes two prepositional phrases.
...
def main():
    sentences = [make_sentence(quantity, tense) for quantity, tense in [(1, "past"), (1, "present"), (1, "future"), (2, "past"), (2, "present"), (2, "future")]]
