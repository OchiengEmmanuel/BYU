...
def main():
    ...
    chemical_formula = input("Enter the molecular formula of the sample: ").upper() # converts all characters in a string to uppercase

    # Get the mass of a chemical sample in grams from the user.
    mole_sample_mass = float(input("Enter the mass in grams of the sample: "))
    ...
    # Exceed Requiremnt: Call the get_formula_name function 
    # to get the name of the chemical formula.
    formula_name = get_formula_name(chemical_formula, known_molecules_dict).capitalize()

    # Compute the number of moles in the sample.
    # Moles = Mass / Molar Mass
    moles = mole_sample_mass / molar_mass
